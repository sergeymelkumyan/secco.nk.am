(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/admin/about"],{

/***/ "./Resources/assets/js/resources/Info/About.js":
/*!*****************************************************!*\
  !*** ./Resources/assets/js/resources/Info/About.js ***!
  \*****************************************************/
...
var About = function About() {
  ...
  var onFinish = function onFinish(values) {
    _utils__WEBPACK_IMPORTED_MODULE_4__["api"].put("abouts/".concat(state.id), values).then(function (_ref) {
      var data = _ref.data;
      setState(data);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    _utils__WEBPACK_IMPORTED_MODULE_4__["api"].get('abouts').then(function (_ref2) {
      var data = _ref2.data;
      setState(data);
      setLoading(false);
    });
