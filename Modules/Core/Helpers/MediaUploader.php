...
class MediaUploader
{
    ...
    {
        $model = config('core.media.model');

        $media = new $model();

        $media->name = $this->name;
        $media->file_name = '/storage/' . $directory . '/' . $this->fileName;
        $media->disk = $this->disk ?: config('core.media.disk');
        ...
        $media->filesystem()->putFileAs('/' . $directory . '/', $this->file, $this->fileName);
