...
use Modules\Core\Events\TranslationHasBeenSet;
use Modules\Core\Exceptions\AttributeIsNotTranslatable;
...
trait HasTranslations
{
    ...
    protected function normalizeLocale(string $key, string $locale, bool $useFallbackLocale): string
    {
        ...
        if (!is_null($fallbackLocale = config('core.translatable.fallback_locale'))) {
